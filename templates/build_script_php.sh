...
yum-config-manager --add-repo http://mirror.centos.org/centos/8/AppStream/s390x/os/ && yum-config-manager --add-repo http://mirror.centos.org/centos/8/PowerTools/s390x/os/ && yum-config-manager --add-repo http://mirror.centos.org/centos/8/BaseOS/s390x/os/
